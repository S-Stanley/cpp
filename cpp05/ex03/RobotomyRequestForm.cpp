...
RobotomyRequestForm::RobotomyRequestForm(void): _name("RobotomyReques"), _target(""), _grad_sign(72), _grad_exec(45), _is_signed(false)
{
...
RobotomyRequestForm::RobotomyRequestForm(std::string target): _name("RobotomyReques"), _target(target), _grad_sign(72), _grad_exec(45), _is_signed(false)
{
