...
ShrubberyCreationForm::ShrubberyCreationForm(void): _name("ShrubberyCreation"), _target(""), _grad_sign(145), _grad_exec(137), _is_signed(false)
{
...
ShrubberyCreationForm::ShrubberyCreationForm(std::string target): _name("ShrubberyCreation"), _target(target), _grad_sign(145), _grad_exec(137), _is_signed(false)
{
