...
PresidentialPardonForm::PresidentialPardonForm(void): _name(""), _target(""), _grad_sign(25), _grad_exec(5), _is_signed(false)
{
...
PresidentialPardonForm::PresidentialPardonForm(std::string target): _name("PresidentialPardonForm"), _target(target), _grad_sign(25), _grad_exec(5), _is_signed(false)
{
